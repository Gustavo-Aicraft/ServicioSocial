...
class TeoriaDecision(Scene):
    def construct(self):
        ...
        # ============== Slide 2B: Tasa de clasificación errónea (parte 2) ==============
        s2b_l3 = Tex(
        ...
        # ============== Slide 3A: Perdida esperada (parte 1) ==============
        ...
        # ============== Slide 3B: Perdida esperada (parte 2) ==============
        s3b_d = Tex(
        ...
        # Slide R2 — (a) Enfoque generativo (parte 2)
        r2_l1 = Tex(
        ...
        # Slide R3 — (b) Enfoque discriminativo
        ...
        # Slide R4 — (c) Función discriminante
        ...
        # Slide R5 — ¿Por qué preferir posteriores? (intro + 2 puntos)
